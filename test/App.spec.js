...
xdescribe('<Search /> ', () => {
  it('should render the brand', () => {
    ...
    expect (wrapper.contains(<h1 className='brand'>Vletfix</h1>)).to.be.true
  })
...
describe('Store', () => {
  ...
  it('should handle setSearchTerm actions', () => {
    const state = rootReducer({ searchTerm: 'random string' }, { type: 'setSearchTerm', value: 'correct string' })
